...
// import HistoriStatusTransaksi from './HistoryStatus';
...
export default class OrderDetailScreen extends React.Component {
  ...
  render() {
    ...
    // const orderMap = order.map((order, key) => order);
      ...
      <LinearGradient colors={GLOBAL.BackgroundApp} style={styles.wrapper} >
        <StatusBar backgroundColor={GLOBAL.StatusBarColor} barStyle='light-content' hidden={false} />
          ...
          <View style={styles.containerMain}>
              ...
              {/* <KetentuanBuySell tipe={this.state.kodeKetentuan}  /> */}
              <View style={styles.boxWhite}>
                <Text style={styles.txtBlueLittle}>{this.state.headerMetodeBayar}</Text>
                <View style={{flexDirection:'row',alignItems:'center',width:'100%',paddingRight:5}}>
                    <View style={{width:'80%',flexDirection:'row',alignItems:'center'}}>
                      <Image source={{uri:this.state.logoBank}} style={{ width:80, height: 50, resizeMode: "stretch" }}/>
                      <View style={{width:1,height:30,borderColor:'#415566',borderWidth:0.5,marginRight:10,marginLeft:10}}/>
                      <Text style={styles.txtBlueMed}>{this.state.noRekening}</Text>
                    </View>
                    <View style={{alignItems:'center',justifyContent:'flex-end',width:'20%'}}>
                      <AwesomeButton
                        borderRadius={8}
