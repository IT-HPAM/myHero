                            ...
                            <View style={[styles.containerMain, { marginBottom: 25 }]}>
                                ...
                                <View style={styles.inputGroup} >
                                    ...
                                    <View style={{ borderRadius: 10, borderColor: "#FFF", borderWidth: 1, padding: 10 }}>
                                        ...
                                        <View style={styles.textInputGroup}>
                                            <TextInput placeholderTextColor="#000" ref={this.field3} style={styles.textInput} placeholder="Kode Pos" value={this.state.kodePosValue} keyboardType='number-pad' onChangeText={(kodePosValue) => this.setState({ kodePosValue })} />
                                        </View>
