...
class RegistPage4 extends React.Component {
    ...
    onFinish = () => {
        if (this.state.bankValue.length == 0 || this.state.bankValue == "Pilih Bank" || this.state.bankId == "") {
            Alert.alert('Perhatian', 'Pilihan bank tidak tersedia',
                [{
                    text: 'OK',
                    onPress: () => {
        ...
        } else if (this.state.noRekValue.length == 0) {
            Alert.alert('Perhatian', 'No Rekening tidak boleh kosong',
                [{
                    text: 'OK',
                    onPress: () => {
        ...
        } else if (!this.state.noRekValue.match(GLOBAL.numbersFormat)) {
            Alert.alert('Perhatian', 'No Rekening tidak valid',
                [{
                    text: 'OK',
                    onPress: () => {
                        const textInput = this.field2.current;
        ...
        } else if (this.state.namaRekValue.length == 0) {
            Alert.alert('Perhatian', 'Nama Rekening tidak boleh kosong',
                [{
                    text: 'OK',
                    onPress: () => {
            ...
            Alert.alert('Perhatian', 'Profile risiko tidak boleh kosong',
                [{
                    text: 'OK',
        ...
        } else if (this.state.pinValue.length != 6) {
            Alert.alert('Perhatian', 'Pin tidak boleh kurang atau lebih dari 6 digit',
                [{
                    text: 'OK',
                    onPress: () => {
        ...
        } else if (!this.state.pinValue.match(GLOBAL.numbersFormat)) {
        ...
        } else if (this.state.pinValue != this.state.pinKonfirmValue) {
            ...
            // this.setState({ test: 'foto_ktp: '+this.state.fotoKtpValue+'\n foto_selfi: '+this.state.fotoSelfiValue+'\n foto_ttd :'+this.state.fotoTtdValue+'\n no_ktp: '+ this.state.noKtpValue+'\n jenis_kelamin: '+this.state.jkId+'\n tgl_lahir: '+tgl_lahir+'\n tempat_lahir: '+this.state.tempatLahirValue+'\n status_nikah: '+ this.state.statusNikahId+'\n agama: '+this.state.agamaId+'\n alamat_ktp: '+this.state.alamatValue+'\n kota_ktp: '+this.state.kotaId+'\n kode_pos_ktp: '+ this.state.kodePosValue+'\n alamat_domisili: '+this.state.alamatDomValue+'\n kota_domisili: '+this.state.kotaDomId+'\n kode_pos_domisili: '+this.state.kodePosDomValue+'\n alamat_surat: '+this.state.alamatSuratValue+'\n pendidikan: '+this.state.pendidikanId+'\n pekerjaan: '+this.state.pekerjaanId+'\n penghasilan: '+this.state.penghasilanId+'\n sumberdana: '+this.state.sumberdanaId+'\n tujuan_investasi: '+this.state.tujInvestId+'\n profil_risiko: '+ this.state.profileRisikoId+'\n bank_id: '+this.state.bankId+'\n no_rek: '+this.state.noRekValue+'\n nama_rekening_bank: '+this.state.namaRekValue+'\n pin: '+this.state.pinValue})
    ...
    //     if (this.state.dataBank.length > 0) {
    //         const newData = this.state.dataBank.filter(item => {
    //             const itemData = item.bank.toUpperCase();
    //             const textData = text.toUpperCase();

    //             return itemData.indexOf(textData) > -1;
    //         });
    //         this.setState({dataBankOption: newData});
    //         if (newData.length > 0) {
                    ...
                    <ScrollView
                        ...
                        <View style={[styles.containerMain, { marginBottom: 25 }]}>
                            ...
                            <View style={styles.inputGroup} >
                                ...
                                <View style={styles.textInputGroup}>
                                    <TextInput placeholderTextColor="#000000" ref={this.field2} onSubmitEditing={() => {
                                        const textInput = this.field3.current;
                                        textInput.focus()
                                    }} style={styles.textInput} placeholder="No Rekening Bank" keyboardType='number-pad' value={this.state.noRekValue} onChangeText={(noRekValue) => this.setState({ noRekValue })} />
                                </View>
                            </View>
                            ...
                            <View style={styles.inputGroup} >
                                ...
                                <View style={styles.textInputGroup}>
                                    <TextInput placeholderTextColor="#000000" ref={this.field3} style={styles.textInput} placeholder="Nama Pada Rekening Bank" keyboardType='default' value={this.state.namaRekValue} onChangeText={(namaRekValue) => this.setState({ namaRekValue })} />
                                </View>
                            </View>
                            ...
                            <View style={styles.inputGroup} >
                                ...
                                <View style={styles.textInputGroup}>
                                    <TextInput {...this.props}
                                        ...
                                        onChangeText={(pinValue) => this.setState({ pinValue })} />
                            ...
                            <View style={styles.inputGroup} >
                                ...
                                <View style={styles.textInputGroup}>
                                    <TextInput {...this.props}
                                        ...
                                        onChangeText={(pinKonfirmValue) => this.setState({ pinKonfirmValue })} />
                ...
                <View style={styles.boxBtnBottom}>
                    <View style={{ flexDirection: "row", flex: 1, paddingRight: 15, paddingLeft: 15 }}>
                        {/* <TouchableOpacity style={styles.btnBottomPrev} onPress={this.onPreviuos}>
                            ...
                            <TouchableOpacity style={styles.btnBottomNext} onPress={this.onFinish}>
